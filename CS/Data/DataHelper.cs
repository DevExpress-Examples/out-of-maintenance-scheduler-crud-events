...
namespace DXSample.Data {
    public class DataHelper {
        ...
        public static AppointmentEntity TrainingFrenchLesson() {
            ...
            appt.RecurrenceInfo = RecurrenceBuilder.Weekly(newStart, 100).ByDay(WeekDays.EveryDay).Build().ToXml();
            return appt;
        }
        public static AppointmentEntity TrainingGermanLesson() {
            DateTime start = Start.AddHours(20).AddMinutes(40);            
            DateTime newStart = start;
            DateTime newEnd = newStart.AddHours(1.5);
            var appt = new AppointmentEntity() {
                AppointmentType = (int)AppointmentType.Pattern,
            ...
            appt.RecurrenceInfo = RecurrenceBuilder.Weekly(newStart, 10).ByDay(WeekDays.EveryDay).Build().ToXml();
            return appt;
        }
        ...
        #endregion
        public static ObservableCollection<AppointmentEntity> GetAppointments() {
            ObservableCollection<AppointmentEntity> collection = new ObservableCollection<AppointmentEntity>();
            DataHelper.Gym().ToList().ForEach(x => collection.Add(x));            
            collection.Add(DataHelper.Dentist());
            collection.Add(DataHelper.Dinner());
            collection.Add(DataHelper.Disneyland());
            collection.Add(DataHelper.RR());
            collection.Add(DataHelper.DayOff());
            collection.Add(DataHelper.SecondShift());
            collection.Add(DataHelper.ConferenceCompanyMeeting());
            collection.Add(DataHelper.ConferenceCustomerRetentionReview());
            collection.Add(DataHelper.ConferenceDatabaseAndWebsiteReview());
            collection.Add(DataHelper.ConferenceWeeklyMeeting());
            collection.Add(DataHelper.TrainingFrenchLesson());
            collection.Add(DataHelper.TrainingGermanLesson());
            collection.Add(DataHelper.TrainingTrainStaffOnNewRemoteControls());
            return collection;
        }
        public static ObservableCollection<ResourceEntity> GetResources() {
            ObservableCollection<ResourceEntity> collection = new ObservableCollection<ResourceEntity>();
            collection.Add(DataHelper.Personal());
            collection.Add(DataHelper.Education());
            collection.Add(DataHelper.Work());
            return collection;
        }
    }
}
