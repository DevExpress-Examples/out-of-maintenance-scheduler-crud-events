...
'#Region "Appointments"
        ...
        Public Shared Function TrainingFrenchLesson() As AppointmentEntity
            ...
            appt.RecurrenceInfo = DevExpress.Xpf.Scheduling.RecurrenceBuilder.Weekly(CDate((newStart)), CInt((100))).ByDay(CType((DevExpress.XtraScheduler.WeekDays.EveryDay), DevExpress.XtraScheduler.WeekDays)).Build().ToXml()
            Return appt
        End Function

        Public Shared Function TrainingGermanLesson() As AppointmentEntity
            Dim start As System.DateTime = DXSample.Data.DataHelper.Start.AddHours(CDbl((20))).AddMinutes(40)
            Dim newStart As System.DateTime = start
            Dim newEnd As System.DateTime = newStart.AddHours(1.5)
            ...
            appt.RecurrenceInfo = DevExpress.Xpf.Scheduling.RecurrenceBuilder.Weekly(CDate((newStart)), CInt((10))).ByDay(CType((DevExpress.XtraScheduler.WeekDays.EveryDay), DevExpress.XtraScheduler.WeekDays)).Build().ToXml()
            Return appt
        End Function
...
'#End Region
        Public Shared Function GetAppointments() As ObservableCollection(Of DXSample.Data.AppointmentEntity)
            Dim collection As System.Collections.ObjectModel.ObservableCollection(Of DXSample.Data.AppointmentEntity) = New System.Collections.ObjectModel.ObservableCollection(Of DXSample.Data.AppointmentEntity)()
            System.Linq.Enumerable.ToList(Of DXSample.Data.AppointmentEntity)(DXSample.Data.DataHelper.Gym()).ForEach(Sub(x) collection.Add(x))
            collection.Add(DXSample.Data.DataHelper.Dentist())
            collection.Add(DXSample.Data.DataHelper.Dinner())
            collection.Add(DXSample.Data.DataHelper.Disneyland())
            collection.Add(DXSample.Data.DataHelper.RR())
            collection.Add(DXSample.Data.DataHelper.DayOff())
            collection.Add(DXSample.Data.DataHelper.SecondShift())
            collection.Add(DXSample.Data.DataHelper.ConferenceCompanyMeeting())
            collection.Add(DXSample.Data.DataHelper.ConferenceCustomerRetentionReview())
            collection.Add(DXSample.Data.DataHelper.ConferenceDatabaseAndWebsiteReview())
            collection.Add(DXSample.Data.DataHelper.ConferenceWeeklyMeeting())
            collection.Add(DXSample.Data.DataHelper.TrainingFrenchLesson())
            collection.Add(DXSample.Data.DataHelper.TrainingGermanLesson())
            collection.Add(DXSample.Data.DataHelper.TrainingTrainStaffOnNewRemoteControls())
            Return collection
        End Function

        Public Shared Function GetResources() As ObservableCollection(Of DXSample.Data.ResourceEntity)
            Dim collection As System.Collections.ObjectModel.ObservableCollection(Of DXSample.Data.ResourceEntity) = New System.Collections.ObjectModel.ObservableCollection(Of DXSample.Data.ResourceEntity)()
            collection.Add(DXSample.Data.DataHelper.Personal())
            collection.Add(DXSample.Data.DataHelper.Education())
            collection.Add(DXSample.Data.DataHelper.Work())
            Return collection
        End Function
    End Class
End Namespace
